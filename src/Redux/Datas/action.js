...
export const CreateReport = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hms-backend-dux4.onrender.com/reports/create",
      data
    );
    console.log(res);
    return res.data;
...
export const AddPatients = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hms-backend-dux4.onrender.com/patients/register",
      data
    );
    return res.data;
    // dispatch({
...
export const CreateBeds = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hms-backend-dux4.onrender.com/beds/add",
      data
    );
    return res.data;
    // dispatch({
...
export const CreatePayment = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hms-backend-dux4.onrender.com/payments/add",
      data
    );
...
export const GetSingleBed = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hms-backend-dux4.onrender.com/beds/single",
      data
    );
    // console.log(res);
    return res.data;
...
export const EditSingleBed = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `https://hms-backend-dux4.onrender.com/beds/${id}`,
      data
    );
    // console.log(res);
    return res.data;
...
export const GetAllAppointment = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://hms-backend-dux4.onrender.com/appointments`
    );
    // console.log(res.data);
    // return res.data;
    dispatch({
...
export const DeleteAppointment = (id) => async (dispatch) => {
  try {
    ...
    const res = await axios.delete(
      `https://hms-backend-dux4.onrender.com/appointments/${id}`
    );
    console.log(res.data);
    // return res.data;
    dispatch({
...
export const GetAllReports = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://hms-backend-dux4.onrender.com/reports`
    );
    // console.log(res.data);
    return res.data;
    // dispatch({
